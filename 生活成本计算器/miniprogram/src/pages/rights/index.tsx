...
import { computeOvertimePay, computeMinWageCheck, assessOvertimeClaim, buildOvertimePrompt, buildMinWagePrompt } from '../../core';
      ...
      <View className="card calc">
        ...
        {ot && !ot.error && (
          <View className="result-box">
            ...
            <Button className="btn-ask" onClick={() => setPrompt(buildOvertimePrompt(Number(otWage) || 0, Number(wd) || 0, Number(we) || 0, Number(ho) || 0, 0, 1, true, '部分', ''))}>问 AI：怎么把加班费要回来</Button>
          </View>
        )}
      </View>
      ...
      <View className="card calc">
        ...
        {mw && !mw.error && (
          <View className="result-box">
            ...
            <Button className="btn-ask" onClick={() => setPrompt(buildMinWagePrompt(Number(mwWage) || 0, TIERS[tierIdx]))}>问 AI：工资低怎么办</Button>
          </View>
        )}
      </View>
